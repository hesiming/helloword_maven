...
public class CircleProgressBar extends View {
	...
	public void setProgressNotInUiThread(float progress) {
		DebugLog.e(TAG, "setProgressNotInUiThread。。。 " + this.hashCode() + "progress" + progress);
	...
	public void setShowViewTypeEnum(ShowViewTypeEnum showViewTypeEnum) {
		...
		DebugLog.e(TAG, "setShowViewTypeEnum。。。 " + this.hashCode());
		this.invalidate();
	}
	...
	protected void onDraw(Canvas canvas) {
		DebugLog.i(TAG, "onDraw 。。。" + this.hashCode() + ", showViewTypeEnum=" + showViewTypeEnum);
