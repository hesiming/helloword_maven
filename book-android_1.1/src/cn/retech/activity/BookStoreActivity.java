...
public class BookStoreActivity extends FragmentActivity implements ICustomControlDelegate {
  ...
  public void onConfigurationChanged(Configuration newConfig) {
    ...
    ((MyGridLayout) findViewById(R.id.book_list_gridView)).updateData();
  }
  ...
  private void publicLibraryButtonOnClickListener() {
    ...
    LogonNetRequestBean netRequestBean =
        new LogonNetRequestBean.Builder(GlobalConstant.publicUserName, GlobalConstant.publicUserPassword).builder();
    DomainBeanNetworkEngineSingleton.getInstance.requestDomainProtocol(netRequestIndexForLoginPublicLibrary, netRequestBean,
        new IDomainBeanAsyncNetRespondListener() {
          @Override
          public void onFailure(NetErrorBean error) {
