...
public class BookShelfActivity extends Activity {
  ...
  private DragGridLayout bookstoreGridView;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    bookstoreGridView = (DragGridLayout) findViewById(R.id.bookstore_gridView);
    // 去除点击效果
    ...
    // GlobalDataCacheForMemorySingleton.getInstance.getLocalBookList().get(position);
    // switch (book.getBookStateEnum()) {
    // case kBookStateEnum_Downloading:// 正在下载中...
    // // 正在下载中的书籍需要先暂停
    // book.stopDownloadBook();
    ...
    // 设置各种Icon
    mSearchLayout.setIconBackground(R.drawable.ic_search_head_shelf, R.drawable.ic_search_edittext_shelf,
        R.drawable.selector_cancel_button_shelf);
  ...
  private void loginForPrivateLibrary(final String userID, final String userPassWord) {
    ...
    DomainBeanNetworkEngineSingleton.getInstance.requestDomainProtocol(netRequestIndexForLoginPrivateLibrary, netRequestBean,
        new IDomainBeanAsyncNetRespondListener() {
          @Override
